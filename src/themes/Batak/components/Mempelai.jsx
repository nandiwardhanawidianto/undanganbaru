      ...
      >
        ...
        >
          <div className="relative w-48 h-72 mx-auto mb-4">
            ...
            {/* Bingkai foto */}
            <motion.div
              className="relative z-10 overflow-hidden border-4 border-batak-600 shadow-md shadow-black/30 rounded-full w-full h-full"
          ...
          <h3 className="text-3xl mb-2 font-bold text-batak-600">
        ...
        {/* Simbol & */}
        <motion.div
          className="text-5xl font-cursive font-bold text-batak-600"
        ...
        >
          ...
          <h3 className="text-3xl font-bold mb-2 text-batak-600">
