...
import bgcount from "../assets/Bg_AkadResepsipink.png";
...
export default function Counttanggal({ data }) {
  ...
  return (
    ...
    >
      {/* card utama */}
      <motion.div
        className="relative z-10 max-w-[360px] w-full bg-white border-4 border-batak-600 rounded-[60px] overflow-hidden shadow-lg"
...
function CounterBox({ value, label }) {
  ...
  return (
    ...
    >
      <motion.div
        className="bg-batak-600 rounded-lg shadow-md p-2 min-w-[65px] backdrop-blur-sm"
