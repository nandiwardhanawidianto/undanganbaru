...
import bunga from "../assets/bungabiru.png";
  ...
  return (
    <section id="mempelai" className="relative min-h-screen flex items-center justify-center p-6">
      ...
      >
        ...
        >
          <div className="relative w-48 h-72 mx-auto mb-4">
            <motion.img
              src={bunga}
              alt="bunga dekoratif"
              className="absolute -bottom-1 -left-2 w-32 rotate-[-25deg] opacity-90 z-0 pointer-events-none"
            ...
            {/* Bingkai foto */}
            <motion.div
              className="relative z-10 overflow-hidden border-4 border-biru-500 shadow-md shadow-black/30 rounded-full w-full h-full"
          ...
          <h3 className="text-3xl mb-2 font-bold text-biru-500">
        ...
        {/* Simbol & */}
        <motion.div
          className="text-5xl font-cursive font-bold text-biru-500"
        ...
        >
          ...
          <h3 className="text-3xl font-bold mb-2 text-biru-500">
