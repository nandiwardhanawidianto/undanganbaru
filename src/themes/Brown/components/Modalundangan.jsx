    ...
    >
      ...
      <div className="relative z-10 text-center text-white max-w-md mb-4 pb-10">
        <div className="relative flex flex-col items-center justify-center">
          <motion.div
            className="text-coklat-700 text-2xl mb-4 font-semibold tracking-wider font-judul"
          ...
          <motion.div
            className="text-4xl italic font-display text-coklat-700 mb-8 leading-relaxed"
          ...
          >
            <p className="text-xl text-coklat-700 font-medium">
              Kepada Yth. Bapak/Ibu/Saudara/i
            </p>
            <p className="text-2xl italic text-coklat-700 mt-3 font-semibold">
              {namaTamu}
            </p>
          </motion.div>
          ...
          <motion.button
            onClick={handleBuka}
            className="text-white px-10 py-4 rounded-full font-bold hover:scale-105 transition-all duration-300 flex items-center gap-3 mx-auto border-2 border-white bg-coklat-700 hover:bg-coklat-700 shadow-xl shadow-black/40"
            initial={{ opacity: 0, y: 10 }}
            animate={{ opacity: 1, y: 0 }}
