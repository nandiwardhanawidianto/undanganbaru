...
export default function Tanggal({ data }) {
  ...
  return (
    <section
      id="tanggal"
      className="relative min-h-screen flex flex-col items-center justify-center p-6 bg-hijau-500"
      style={{
        ...
        {acaras.map((acara, i) => (
          ...
          >
            ...
            <div className="absolute inset-0 flex items-center justify-center p-8">
              <motion.div
                className="text-center text-hijau-800 rounded-3xl px-6 py-8"
              ...
              >
                ...
                {acara.link_acara && (
                  <a
                    ...
                    className="inline-flex items-center justify-center gap-2 bg-hijau-500 text-white font-medium py-2 px-6 rounded-full shadow-md hover:bg-hijau-600 hover:shadow-lg transition-all mt-5"
                  >
