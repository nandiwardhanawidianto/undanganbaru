...
import sageAnim from "../assets/lottie/Bali.json";
        ...
        <div className="relative z-10 w-full max-w-6xl mx-auto px-4 flex flex-col items-center justify-center">
          <div className="relative flex items-center justify-center w-full">
            <div className="absolute inset-0 flex flex-col items-center justify-center text-center z-20">
              <motion.h1
                className="text-lg md:text-2xl text-bali-500 mb-4 mt- font-semibold tracking-wider font-judul uppercase"
              ...
              <motion.div
                className="flex flex-col items-center text-center text-4xl italic font-display text-bali-500 gap-y-2 mb-6"
              ...
              <motion.div
                className="text-2xl italic font-display text-bali-500 mb-8"
                initial={{ scale: 0.7, opacity: 0 }}
                animate={{ scale: 1, opacity: 1 }}
              ...
              <motion.a
                href="#"
                className="inline-flex items-center gap-3 text-bali-500 px-8 py-2 rounded-full font-bold hover:scale-105 transition-all duration-300 shadow-xl shadow-hijau-700/50 border-2 border-bali-500 hover:bg-white"
              ...
              >
                <FaChevronDown className="text-2xl text-bali-500 mb-2 animate-bounce" />
                <span className="text-xl text-bali-500 shadow-sm">Scroll Down</span>
              </motion.div>
            </div>
          </div>
        </div>
