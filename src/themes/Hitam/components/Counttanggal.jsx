...
import bgcount from "../assets/Bg_all.png";
...
export default function Counttanggal({ data }) {
  ...
  // Foto countdown dari CMS, fallback ke foto default tema
...
function CounterBox({ value, label }) {
  ...
  return (
    ...
    >
      <motion.div
        className="bg-hitam-500 rounded-lg shadow-md p-2 min-w-[65px] backdrop-blur-sm"
