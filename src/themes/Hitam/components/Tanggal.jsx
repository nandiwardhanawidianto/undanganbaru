...
import bgtanggal2 from "../assets/Bg_AkadResepsiHitam.png";
              ...
              <div className="absolute inset-0 flex items-center justify-center p-8">
                ...
                >
                  ...
                  <div className="mt-3 flex flex-col items-center text-base">
                    <SiGooglemaps className="text-hitam-500 w-8 h-8 mb-1" />
                    <p>Bertempat di</p>
                  ...
                  {acara.link_acara && (
                    <a
                      ...
                      className="inline-flex items-center justify-center gap-2 bg-hitam-500 text-white font-medium py-2 px-6 rounded-full shadow-md hover:bg-hitam-500 hover:shadow-lg transition-all mt-5"
                    >
  ...
  return (
    ...
    >
      <div className="bg-krem/90 rounded-xl shadow-md p-3 min-w-[70px] backdrop-blur-sm">
        <div className="text-xl font-bold text-hitam-500">
          {displayValue.toString().padStart(2, "0")}
        </div>
        <div className="text-base text-hitam-500 mt-1">{label}</div>
      </div>
    </motion.div>
  );
}
