...
import bunga from "../assets/bungahitam.png";
  ...
  return (
    <section id="mempelai" className="relative min-h-screen flex items-center justify-center p-6">
      ...
      >
        ...
        >
Dengan penuh rasa syukur, kami mengundang Bapak/Ibu/Saudara/i untuk berkenan hadir dan memberikan doa serta restu pada acara pernikahan kami:
        ...
        >
          <div className="relative w-48 h-72 mx-auto mb-4">
            <motion.img
              src={bunga}
              alt="bunga dekoratif"
              className="absolute -bottom-1 -left-4 w-32 rotate-[-25deg] opacity-90 z-0 pointer-events-none"
            ...
            {/* Bingkai foto */}
            <motion.div
              className="relative z-10 overflow-hidden border-4 border-hitam-500 shadow-md shadow-black/30 rounded-full w-full h-full"
          ...
          <h3 className="text-3xl mb-2 font-bold text-hitam-500">
        ...
        {/* Simbol & */}
        <motion.div
          className="text-5xl font-cursive font-bold text-hitam-500"
        ...
        >
          <div className="relative w-48 h-72 mx-auto mb-4">
            <motion.img
              src={bunga}
              alt="bunga dekoratif"
              className="absolute -bottom-0 -right-4 w-32 rotate-[25deg] opacity-90 z-0 pointer-events-none"
          ...
          <h3 className="text-3xl font-bold mb-2 text-hitam-500">
