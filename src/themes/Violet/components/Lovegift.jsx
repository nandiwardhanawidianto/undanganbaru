...
import kadoungu from "../assets/KadoUngu.png";
...
export default function LoveGift({ data: propData }) {
  ...
  const resolveLogo = (logoPath) => {
    ...
    if (p.startsWith("bank_logos/")) return `${baseUrl}/storage/${p}`;
    return `${baseUrl}/${p}`;
  };
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        if (mounted) {
          setBankData(normalizeLoveGift(
            json.data?.lovegift ?? json.data?.loveGift ?? json.data?.love_gift ?? json.data?.lovegift_list
          ));
  ...
  // 🔥 Kalau keduanya kosong dan tidak loading, jangan render page
        ...
        {loading ? (
          ...
          <>
                    ...
                    >
                      ...
                      <div className="text-center">
                        ...
                        <motion.button
                          ...
                          whileHover="hover"
                          whileTap="tap"
                          className=" bg-ungu-500 text-white px-4 py-2 rounded-full text-sm transition duration-300"
                        >
            ...
            {kirimKado && (
              ...
              >
                <div className="bg-white border rounded-2xl p-6 max-w-lg w-full text-center flex flex-col items-center">
                <img src={kadoungu} alt="Kado" className="mx-auto mb-4 w-32 h-32 object-contain" />
