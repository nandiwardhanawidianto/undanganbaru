    ...
    >
      ...
      <div className="flex flex-col gap-10 w-full max-w-4xl">
        {acaras.map((acara, i) => (
          <motion.div
            key={acara.id}
            className="relative w-full h-[500px] rounded-[150px] overflow-hidden border-ungu-600 border-4 shadow-lg hover:shadow-2xl transition-all duration-500"
          ...
          >
            ...
            <div className="absolute inset-0 flex items-center justify-center p-8 text-lg">
              <motion.div
                className="text-center text-ungu-600 rounded-3xl px-6 py-8"
              ...
              >
                ...
                {acara.link_acara && (
                  <a
                    ...
                    className="inline-flex items-center justify-center gap-2 bg-ungu-500 text-white font-medium py-2 px-6 rounded-full shadow-md hover:bg-ungu-600 hover:shadow-lg transition-all mt-5"
                  >
