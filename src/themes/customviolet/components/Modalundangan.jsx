    ...
    >
      ...
      <div className="relative z-10 text-center text-white max-w-md mb-4 pb-10 px-4">
        <div className="relative flex flex-col items-center justify-center">
          ...
          {/* Judul Acara */}
          <motion.div
            className="text-2xl sm:text-lg mb-4 font-semibold tracking-wider font-judul uppercase"
            initial={{
              opacity: 0,
              y: 10,
            }}
          ...
          {/* Tanggal */}
          <motion.div
            className="italic font-display text-white mb-6 text-xl sm:text-lg"
            initial={{
              opacity: 0,
              y: 10,
            }}
