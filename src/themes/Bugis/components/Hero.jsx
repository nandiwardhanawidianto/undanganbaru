...
import sageAnim from "../assets/lottie/bugis.json";
        ...
        <div className="relative z-10 w-full max-w-6xl mx-auto px-4 flex flex-col items-center justify-center">
          <div className="relative flex items-center justify-center w-full">
            <div className="absolute inset-0 flex flex-col items-center justify-center text-center z-20">
              <motion.h1
                className="text-lg md:text-2xl text-bugis-500 mb-4 mt- font-semibold tracking-wider font-judul uppercase"
              ...
              <motion.div
                className="flex flex-col items-center text-center text-4xl italic font-display text-bugis-500 gap-y-2 mb-6"
              ...
              <motion.div
                className="text-2xl italic font-display text-bugis-500 mb-8"
                initial={{ scale: 0.7, opacity: 0 }}
                animate={{ scale: 1, opacity: 1 }}
              ...
              >
                <FaChevronDown className="text-2xl text-bugis-500 mb-2 animate-bounce" />
                <span className="text-xl text-bugis-500 shadow-sm">Scroll Down</span>
              </motion.div>
            </div>
          </div>
        </div>
