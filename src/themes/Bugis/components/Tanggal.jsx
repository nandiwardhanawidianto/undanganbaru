          ...
          return (
            ...
            >
              ...
              <div className="absolute inset-0 flex items-center justify-center p-8">
                <motion.div
                  className="text-center text-bugis-500 rounded-3xl px-6 py-8"
                ...
                >
                  ...
                  <div className="mt-3 flex flex-col items-center text-base">
                    <SiGooglemaps className="text-bugis-500 w-8 h-8 mb-1" />
                    <p>Bertempat di</p>
                  ...
                  {acara.link_acara && (
                    <a
                      ...
                      className="inline-flex items-center justify-center gap-2 bg-bugis-500 text-white font-medium py-2 px-6 rounded-full shadow-md hover:bg-bugis-500 hover:shadow-lg transition-all mt-5"
                    >
  ...
  return (
    ...
    >
      <div className="bg-krem/90 rounded-xl shadow-md p-3 min-w-[70px] backdrop-blur-sm">
        <div className="text-xl font-bold text-bugis-500">
          {displayValue.toString().padStart(2, "0")}
        </div>
        <div className="text-base text-bugis-500 mt-1">{label}</div>
      </div>
    </motion.div>
  );
}
