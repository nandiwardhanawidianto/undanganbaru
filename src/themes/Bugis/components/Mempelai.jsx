  ...
  return (
    <section id="mempelai" className="relative min-h-screen flex items-center justify-center p-6">
      ...
      >
        ...
        {/* Deskripsi */}
        <motion.p
          className="text-sm leading-relaxed mt-3 font-sans text-hitam-500"
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
        ...
        >
          <div className="relative w-48 h-72 mx-auto mb-4">
            <motion.img
              src={bunga}
              alt="bunga dekoratif"
              className="absolute -bottom-1 -left-0 w-32 rotate-[-18deg] opacity-90 z-0 pointer-events-none"
            ...
            {/* Bingkai foto */}
            <motion.div
              className="relative z-10 overflow-hidden border-4 border-bugis-500 shadow-md shadow-black/30 rounded-full w-full h-full"
          ...
          <h3 className="text-3xl mb-2 font-bold text-bugis-500">
        ...
        {/* Simbol & */}
        <motion.div
          className="text-5xl font-cursive font-bold text-bugis-500"
        ...
        >
          ...
          <h3 className="text-3xl font-bold mb-2 text-bugis-500">
