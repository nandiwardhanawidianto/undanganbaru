...
export default function Counttanggal({ data }) {
  ...
  return (
    ...
    >
      {/* card utama */}
      <motion.div
        className="relative z-10 max-w-[360px] w-full bg-white border-4 border-bugis-500 rounded-[60px] overflow-hidden shadow-lg"
...
function CounterBox({ value, label }) {
  ...
  return (
    ...
    >
      <motion.div
        className="bg-bugis-500 rounded-lg shadow-md p-2 min-w-[65px] backdrop-blur-sm"
